...
const generateLetterButtons = () => {
  ...
  const container2=document.querySelector('#letter-buttons')
  for (const leter of ALPHABET){
    container2.insertAdjacentHTML('beforeend',`<button>${leter}</button>`)
  }
...
const isLetterInWord = (letter) => {
    return document.querySelector(`div.${char}`) !== null;
};
